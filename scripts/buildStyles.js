const toCapitalize = require('./helpers/toCapitalize');
const toPascalCase = require('./helpers/toPascalCase');
const { choices, decisions } = require('./assets/tokens');
const fs = require('fs');
...
function buildStyles() {
  ...
  fs.writeFile('./src/scripts/archive/styles.js', data, 'utf8', (error) => {
