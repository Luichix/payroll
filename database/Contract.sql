CREATE TABLE `database_payroll`.`CONTRACT` (
  ...
  CONSTRAINT `FK_CONTRACT_USER_ADD`
    FOREIGN KEY (`FK_USER_ADD`)
    REFERENCES `database_payroll`.`USER` (`ID_USER`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `FK_CONTRACT_USER_ALTER`
    FOREIGN KEY (`FK_USER_ALTER`)
    REFERENCES `database_payroll`.`USER` (`ID_USER`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `FK_CONTRACT_USER_LOW`
...
ALTER TABLE `database_payroll`.`CONTRACT` 
